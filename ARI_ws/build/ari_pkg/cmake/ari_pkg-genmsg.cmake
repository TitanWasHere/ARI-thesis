...
add_custom_target(ari_pkg_generate_messages ALL)
...
_generate_module_cpp(ari_pkg
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/ari_pkg
  "${ALL_GEN_OUTPUT_FILES_cpp}"
)

add_custom_target(ari_pkg_generate_messages_cpp
  DEPENDS ${ALL_GEN_OUTPUT_FILES_cpp}
)
add_dependencies(ari_pkg_generate_messages ari_pkg_generate_messages_cpp)
...
add_dependencies(ari_pkg_gencpp ari_pkg_generate_messages_cpp)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS ari_pkg_generate_messages_cpp)
...
### Generating Module File
_generate_module_eus(ari_pkg
  ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/ari_pkg
  "${ALL_GEN_OUTPUT_FILES_eus}"
)

add_custom_target(ari_pkg_generate_messages_eus
  DEPENDS ${ALL_GEN_OUTPUT_FILES_eus}
)
add_dependencies(ari_pkg_generate_messages ari_pkg_generate_messages_eus)
...
add_dependencies(ari_pkg_geneus ari_pkg_generate_messages_eus)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS ari_pkg_generate_messages_eus)
...
### Generating Module File
_generate_module_lisp(ari_pkg
  ${CATKIN_DEVEL_PREFIX}/${genlisp_INSTALL_DIR}/ari_pkg
  "${ALL_GEN_OUTPUT_FILES_lisp}"
)

add_custom_target(ari_pkg_generate_messages_lisp
  DEPENDS ${ALL_GEN_OUTPUT_FILES_lisp}
)
add_dependencies(ari_pkg_generate_messages ari_pkg_generate_messages_lisp)
...
add_dependencies(ari_pkg_genlisp ari_pkg_generate_messages_lisp)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS ari_pkg_generate_messages_lisp)
...
### Generating Module File
_generate_module_nodejs(ari_pkg
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/ari_pkg
  "${ALL_GEN_OUTPUT_FILES_nodejs}"
)

add_custom_target(ari_pkg_generate_messages_nodejs
  DEPENDS ${ALL_GEN_OUTPUT_FILES_nodejs}
)
add_dependencies(ari_pkg_generate_messages ari_pkg_generate_messages_nodejs)
...
add_dependencies(ari_pkg_gennodejs ari_pkg_generate_messages_nodejs)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS ari_pkg_generate_messages_nodejs)
...
add_custom_target(ari_pkg_generate_messages_py
  DEPENDS ${ALL_GEN_OUTPUT_FILES_py}
)
add_dependencies(ari_pkg_generate_messages ari_pkg_generate_messages_py)
...
# target for backward compatibility
add_custom_target(ari_pkg_genpy)
add_dependencies(ari_pkg_genpy ari_pkg_generate_messages_py)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS ari_pkg_generate_messages_py)



if(gencpp_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/ari_pkg)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/ari_pkg
...
if(geneus_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/ari_pkg)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/ari_pkg
...
if(genlisp_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genlisp_INSTALL_DIR}/ari_pkg)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${genlisp_INSTALL_DIR}/ari_pkg
...
if(gennodejs_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/ari_pkg)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/ari_pkg
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/ari_pkg)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/ari_pkg\")")
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/ari_pkg
