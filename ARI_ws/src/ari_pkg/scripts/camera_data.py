...
# [w,x,y,z]
baseFootprint_to_camera = { "position" : [-0.811283314373, -0.0426764168585, -0.745080905223] , "orientation": [0.93228139161, -0.00674844400512, -0.361658040888, 0.00304916720499]}
odom_to_baseFootprint = { "position" : [-1.03404439432, 0.581746398951, 0.0] , "orientation": [0.996312029584, -0.0, -0.0, 0.085804077448]}
map_to_odom = { "position" : [0.0, 0.0, 0.0] , "orientation": [0.0, 0.0, 0.0, 1.0]}