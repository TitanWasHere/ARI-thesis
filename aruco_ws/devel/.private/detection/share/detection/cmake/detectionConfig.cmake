...
if("TRUE" STREQUAL "TRUE")
  set(detection_SOURCE_PREFIX /home/user/exchange/aruco_ws/src/detection)
  set(detection_DEVEL_PREFIX /home/user/exchange/aruco_ws/devel/.private/detection)
  ...
  set(detection_INSTALL_PREFIX /home/user/exchange/aruco_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'detection' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/user/exchange/aruco_ws/src/detection/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/user/exchange/aruco_ws/devel/.private/detection/lib;/home/user/exchange/aruco_ws/devel/lib;/opt/ros/melodic/lib)
