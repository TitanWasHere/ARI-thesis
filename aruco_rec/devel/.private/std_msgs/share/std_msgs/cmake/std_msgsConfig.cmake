...
if("TRUE" STREQUAL "TRUE")
  set(std_msgs_SOURCE_PREFIX /home/user/exchange/aruco_rec/src/std_msgs)
  set(std_msgs_DEVEL_PREFIX /home/user/exchange/aruco_rec/devel/.private/std_msgs)
  set(std_msgs_INSTALL_PREFIX "")
  set(std_msgs_PREFIX ${std_msgs_DEVEL_PREFIX})
else()
  set(std_msgs_SOURCE_PREFIX "")
  set(std_msgs_DEVEL_PREFIX "")
  set(std_msgs_INSTALL_PREFIX /home/user/exchange/aruco_rec/install)
...
if(NOT "/opt/ros/melodic/include;/usr/include " STREQUAL " ")
  set(std_msgs_INCLUDE_DIRS "")
  set(_include_dirs "/opt/ros/melodic/include;/usr/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'std_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/user/exchange/aruco_rec/src/std_msgs/${idir}'.  ${_report}")
    endif()
    _list_append_unique(std_msgs_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "/opt/ros/melodic/lib/libroscpp_serialization.so;/opt/ros/melodic/lib/librostime.so;/opt/ros/melodic/lib/libcpp_common.so;/usr/lib/x86_64-linux-gnu/libboost_system.so;/usr/lib/x86_64-linux-gnu/libboost_thread.so;/usr/lib/x86_64-linux-gnu/libboost_chrono.so;/usr/lib/x86_64-linux-gnu/libboost_date_time.so;/usr/lib/x86_64-linux-gnu/libboost_atomic.so;/usr/lib/x86_64-linux-gnu/libpthread.so;/usr/lib/x86_64-linux-gnu/libconsole_bridge.so.0.4")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/user/exchange/aruco_rec/devel/.private/std_msgs/lib;/home/user/exchange/aruco_rec/devel/lib;/opt/ros/melodic/lib)
